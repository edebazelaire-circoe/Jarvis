...
from jarvis.domain.back_brain import BackBrainAdvisoryReference, BackBrainContextDependency
...
class StateRepository(Protocol):
    ...
    async def back_brain_freshness(self, conversation_id: str, source: SpeechSource, dependencies: tuple[BackBrainContextDependency, ...]) -> tuple[bool, bool | None]: ...
...
@runtime_checkable
class OwnedJobWorker(Protocol):
    """True acknowledges cleanup of this job's owned execution resources."""
