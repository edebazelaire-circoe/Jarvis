# Slice 07 — Metrics, scoring, comparisons, and parameter sweeps

## Goal
Add per-diagnostic metrics/assertions/score contracts, run comparison, and isolated parameter sweeps.
...
## Scope
### In Scope
Metrics/assertions remain primary evidence; score is synthesis. Allow blocking assertions to fail a run regardless of average score. Implement compare-runs and sweep orchestration that fan out isolated TestRuns over declared parameter values. Never write winning values into permanent Jarvis settings automatically.
...
## Dependencies
`02-run-persistence-artifacts`, `04-catalog-scenarios`, `06-virtual-profile-harness`
