# Slice 01 — Test Lab domain contracts and schemas

## Goal
Create the canonical domain models and serialization/schema contracts for diagnostics, profiles, scenarios, TestRuns, metrics/assertions, permissions, and run state.
...
## Scope
### In Scope
Define immutable/stable IDs and versioned schema contracts. Add validators for profile names, diagnostic IDs, parameters, metric/assertion shape, cost/capability declarations, and forbidden arbitrary-code scenario fields. Keep the domain deterministic and I/O-free where practical.
