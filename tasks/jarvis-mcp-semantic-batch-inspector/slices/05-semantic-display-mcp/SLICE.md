# Slice 05 — Semantic jarvis-display migration


## Goal
Map scene tools to user intents, migrate selection-native semantic writes to one Core command, add relative group translation, remove or deprecate redundant granular tools, update prompts/tests/docs, and keep advertised scene tool count at or below 13 unless explicitly justified.
