# Slice 03 — Atomic scene batch operations


## Goal
Implement selection-native patch/update, translate, pin/unpin and generic archive in reducer/Core with full prevalidation, one patch/revision, rigid common-delta translation, structured atomic results, and transport/wire support.
