# Slice 04 — Canonical MCP catalog and typed schemas


## Goal
Create one source of truth for Jarvis MCP tool contracts, semantic categories, side-effect/availability/deprecation metadata, concrete output schemas, safe FastMCP integration or introspection, and protocol parity tests.
