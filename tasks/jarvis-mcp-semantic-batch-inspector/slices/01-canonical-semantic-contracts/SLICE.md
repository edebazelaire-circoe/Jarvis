# Slice 01 — Canonical semantic contracts


## Goal
Freeze exact SceneSelection fields and composition, constellation traversal, atomic batch/no-op/failure semantics, rigid translation rules, MCP catalog metadata/categories/output-schema requirements, migration/tool-count policy and canonical docs.
