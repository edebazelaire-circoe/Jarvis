. /c/Users/Clarice/AppData/Local/Temp/claude/C--Projects-jarvis-sub-agents-jarvis-agent-01/b7d45121-0ea1-4bc3-8741-e66996931033/scratchpad/s6/env.sh || exit 1
cd $W
$PY $S/fake_api.py $QA_FAKE_PORT $(cygpath -w $S/script-empty.json) $(cygpath -w $S/fake-bodies.jsonl) > $S/fake.log 2>&1 &
echo $! > $S/fake.pid
