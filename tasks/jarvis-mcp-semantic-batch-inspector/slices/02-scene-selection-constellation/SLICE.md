# Slice 02 — SceneSelection and canonical constellation


## Goal
Implement the strict domain selection model/resolver, plural kinds, work/group/constellation/near scopes required by contract, canonical runtime-signal owner virtual edges, deterministic bounded results, and browser/domain parity fixtures.
