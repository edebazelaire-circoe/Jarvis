...
Open `tasks/TODO.md`. The first task is an orchestration task. It requires the implementation agent to read the durable docs, verify the repository still matches the source snapshot, then execute the numbered coding slices in order.
