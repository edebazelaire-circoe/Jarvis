...
- [x] 00 - Orchestrator and plan ownership
- [x] 01 - Pin upstream snapshots and establish third-party boundaries
- [x] 02 - Create Jarvis core skeleton and typed contracts
- [x] 03 - Implement state machine and file signal bus
- [x] 04 - Implement push-to-talk and OpenAI transcription
- [x] 05 - Implement AgentBackend and minimal tool registry
- [x] 06 - Implement TTS and interruption loop
- [x] 07 - Implement ActionBroker and confirmation flow
- [x] 08 - Implement Markdown memory and local search index
- [ ] 09 - Harden and integrate Barehands - implementation complete; manual offline/auth/gesture acceptance pending
- [ ] 10 - Integrate visualizer, launcher and health diagnostics - implementation complete; physical full-stack launch acceptance pending
- [ ] 11 - Run E2E security/quality gates and produce final report - automated gates/report complete; live-provider/hardware latency gates pending
